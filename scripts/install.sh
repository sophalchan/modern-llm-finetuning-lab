...
echo ""
echo "Project 1 (QLoRA) — works on 8GB GPU (Qwen 1.5B, no HF token):"
echo "  python project1_unsloth_qlora/train_qwen_qlora.py --config project1_low_vram.yaml"
echo "  python project1_unsloth_qlora/infer_qwen_qlora.py --prompt \"Explain QLoRA briefly.\""
echo ""
echo "Project 1 (Unsloth + Llama 8B) — needs 16GB+ VRAM + HF_TOKEN in .env:"
echo "  pip install \"unsloth[colab-new] @ git+https://github.com/unslothai/unsloth.git\""
echo "  python project1_unsloth_qlora/train_llama31_unsloth.py"
